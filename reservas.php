<?php
    function submit_forms(){
        if(isset($_POST['submit'])){
            ...
            $result = mysqli_query($conexao, "INSERT INTO TBreserva_lab(/*resID,*/ resNOME_CURSO_DISCIPLINA, resNOME_DEPARTAMENTO, resNOME_RESP_CURSO_DISCIPLINA, resNOME_PROF_CURSO_DISCIPLINA, resDATA_RESERVA/*Horario*/, resHORA_RESERVA, resQTD_ALUNOS, resNOME_PROGRAMAS, resEMAIL_RESP_RESERVA, resCIENTE, resMSG_OBS)
            VALUES(
            '$Curso_Disciplina',
            '$Departamento',
            '$Responsavel',
